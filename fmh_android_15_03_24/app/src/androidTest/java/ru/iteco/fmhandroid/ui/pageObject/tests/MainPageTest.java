...
public class MainPageTest {
    ...
    @Description("ТК.22 Открытие навигационного меню")
    @Test
    ...
    @Description("ТК.23 Переход на страницу 'Новости'")
    @Test
    ...
    @Description("ТК.24 Переход на страницу 'О приложении'")
    @Test
    ...
    @Description("ТК.28 Переход на страницу 'Новости' через вкладку 'Все новости'")
    @Test
    ...
    @Description("ТК.29 Выход из приложения")
    @Test
